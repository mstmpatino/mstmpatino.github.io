...
The objective of the project was to create a code that allowed the user to choose different options concerning family history. The user can add a relative, delete a relative, or update information that will be processed and stored. 



I have attached a link to the code written, but to test it needs to be copied and pasted into a program capable of running python programs.
